...
int main()
{
    ...
    //display prompt and input of the feet and inches, needs a space in between the numbers and can be done all on one line, then displays what has been entered in feet and inches
